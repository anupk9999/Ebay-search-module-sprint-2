...
public class locators extends Browser{
	...
	public static WebElement Productnamexcel(){
		WebElement productname = driver.findElement(By.xpath("SearchBox"));
		return productname;
	}
	...
	public static WebElement Product_List() {
		WebElement productlist = driver.findElement(By.xpath("//h3[@class='Productsearch']"));
		productlist.click();
		return productlist;
	}
...
//	}
	...
	public static void allcategories() {
		WebElement allcategory = driver.findElement(By.xpath("//*[@id='AllCateorgy']"));
		allcategory.click();
	}
	public static void advancesearching() {
		WebElement advancesearch = driver.findElement(By.xpath("//a[@href='Advance_search']"));
		advancesearch.click();
	}
	public static void SectionCategory() {
		WebElement sectioncategory = driver.findElement(By.xpath("Sectionwiseseach"));
		sectioncategory.click();
	}
	public static void shopbycategory() {
		WebElement shopbycategory = driver.findElement(By.xpath("Shopbycategory"));
		shopbycategory.click();
	}
	public static void deals() {
		WebElement dealsoftheday = driver.findElement(By.xpath("TodaysDeals"));
		dealsoftheday.click();
	}
}
